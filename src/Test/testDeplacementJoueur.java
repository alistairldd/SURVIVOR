...
public class testDeplacementJoueur {
    ...
    public static void main(String[] args) {
        ...
        assertEquals(0, (int) joueur.getX(), "Position X initiale");
        assertEquals(0, (int) joueur.getY(), "Position Y initiale");

        // Simuler un clic dans la carte
        System.out.println("Test: déplacement à (100,150)");
        joueur.deplaceX(100);
        joueur.deplaceY(150);
        assertEquals(100, (int) joueur.getX(), "Position X après déplacement");
        assertEquals(150, (int) joueur.getY(), "Position Y après déplacement");
        ...
        assertEquals(taille, (int) joueur.getX(), "Position X après déplacement hors limites (max)");
        assertEquals(20, (int) joueur.getY(), "Position Y après déplacement hors limites (min)");
