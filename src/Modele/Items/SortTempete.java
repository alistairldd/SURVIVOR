...
public class SortTempete extends Sort {
    ...
    public SortTempete(double x, double y, double dirX, double dirY) {
        super("Sort de Tempête", PRIX_SORTS_TEMPETE, IMAGE_SORT_TEMPETE, TEMPETE_KNOCKBACK_FORCE, x, y, dirX, dirY);
        this.vitesse = 4.0;
     ...
     */
    public SortTempete() {
        super("Sort de Tempête", PRIX_SORTS_TEMPETE, IMAGE_SORT_TEMPETE, 300);
    }
}